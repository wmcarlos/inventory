...
require_once('../controladores/corTunidad.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tunidad','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Tunidad','total',$id); ?>
</div>
</form>
<!--
	Codigo
