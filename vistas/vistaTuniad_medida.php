...
require_once('../controladores/corTuniad_medida.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tuniad_medida','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Tuniad_medida','total',$id); ?>
</div>
</form>
<!--
	Codigo
