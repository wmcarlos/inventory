...
require_once('../controladores/corTcargo.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tcargo','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Tcargo','total',$id); ?>
</div>
</form>
<!--
	Codigo
