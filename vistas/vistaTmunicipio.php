...
require_once('../controladores/corTmunicipio.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tmunicipio','codigo');
}
?>
...
<td><select name='txtcodigo_estado' disabled='disabled' id='txtcodigo_estado' class='validate[required]'>
	...
	<?php print $objFunciones->crear_combo("testado","codigo","nombre",$lcCodigo_estado); ?>
</select></td>
</tr>
...
<?php $objFunciones->botonera_general('Tmunicipio','total',$id); ?>
</div>
</form>
<!--
	Codigo
