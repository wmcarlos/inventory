...
require_once('../controladores/corTmodelo.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tmodelo','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Tmodelo','total',$id); ?>
</div>
</form>
<!--
	Codigo
