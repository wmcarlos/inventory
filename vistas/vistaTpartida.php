...
require_once('../controladores/corTpartida.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tpartida','codigo');
}
?>
...
<tr>
<td align='right'><span class='rojo'>*</span> Identificador:</td>
<td><input type='text' disabled='disabled' maxlength='' name='txtidentificador' value='<?php print($lcIdentificador);?>' id='txtidentificador' class='validate[required]'/></td>
</tr>
<tr>
...
<?php $objFunciones->botonera_general('Tpartida','total',$id); ?>
</div>
</form>
<!--
	Codigo
